...
- (id)init
{
	...
	titleLabel.frame = CGRectOffset( titleLabel.frame, 18, 22 );
	[self addSubview:titleLabel];
	
	_tableView = [[UITableView alloc] initWithFrame:CGRectMake( 21, 60, 255, 330 )];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
	if( section == 1 )
	{
		UIView *headerView = [[UIView alloc] initWithFrame:CGRectMake( 0, 0, 255, 30 )];
		...
		titleLabel.shadowOffset = CGSizeMake( 0, 1 );
		[titleLabel sizeToFit];
		titleLabel.frame = CGRectMake( ( 255 - titleLabel.frame.size.width ) / 2, 0, titleLabel.frame.size.width, titleLabel.frame.size.height );
		[headerView addSubview:titleLabel];
		
		UIImageView *leftDecoView = [[UIImageView alloc] initWithFrame:CGRectMake( titleLabel.frame.origin.x - 23, 7, 15, 7 )];
		leftDecoView.image = [UIImage imageNamed:@"recipe_title_deco_left.png"];
		[headerView addSubview:leftDecoView];
		
		UIImageView *rightDecoView = [[UIImageView alloc] initWithFrame:CGRectMake( titleLabel.frame.origin.x + titleLabel.frame.size.width + 8, 7, 15, 7 )];
		rightDecoView.image = [UIImage imageNamed:@"recipe_title_deco_right.png"];
		[headerView addSubview:rightDecoView];
		
		UIImageView *lineView = [[UIImageView alloc] initWithFrame:CGRectMake( 5, 37, 255, 5 )];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	if( indexPath.section == 0 )
	{
		...
		if( !cell )
		{
			...
			UIImageView *knifeIconView = [[UIImageView alloc] initWithFrame:CGRectMake( 0, 10, 20, 20 )];
			knifeIconView.image = [UIImage imageNamed:@"recipe_icon_knife.png"];
			[cell.contentView addSubview:knifeIconView];
			
			_servingsInput = [[UITextField alloc] initWithFrame:CGRectMake( 26, 10, 100, 30 )];
			...
			UIImageView *separatorLineView = [[UIImageView alloc] initWithFrame:CGRectMake( 131, 10, 4, 20 )];
			separatorLineView.image = [UIImage imageNamed:@"recipe_line_thin_vertical.png"];
			[cell.contentView addSubview:separatorLineView];
			
			UIImageView *clockIconView = [[UIImageView alloc] initWithFrame:CGRectMake( 140, 10, 20, 20 )];
			clockIconView.image = [UIImage imageNamed:@"recipe_icon_clock.png"];
			[cell.contentView addSubview:clockIconView];
			
			_minutesInput = [[UITextField alloc] initWithFrame:CGRectMake( 167, 10, 100, 30 )];
			...
			UIImageView *lineView = [[UIImageView alloc] initWithFrame:CGRectMake( 5, 40, 255, 4 )];
			lineView.image = [UIImage imageNamed:@"recipe_line_thin.png"];
