...
- (void)startLoading
{
	...
	if( _queue.count > 0 )
	{
		APILoaderToken *token = [_queue objectAtIndex:0];
...
- (void)loadToken:(APILoaderToken *)token
{
	NSMutableURLRequest *request;
	
	if( token.method == APILoaderMethodGET )
	{
...
- (NSMutableURLRequest *)GETRequest:(APILoaderToken *)token
{
...
- (NSMutableURLRequest *)POSTRequest:(APILoaderToken *)token
{
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
	...
	APILoaderToken *token = [[_queue objectAtIndex:0] retain];
